...
NO_COVER = {
    ...
    # وهذا لسببٍ آخَر: غلافُ الوثيقة يحمل شعارَ الدولة وشعارَ وزارة الأوقاف،
    # لأنّها وثيقتُهم. وعرضُه في واجهةِ التطبيق يُقرَأ اعتماداً منهم له، والتطبيقُ
    # لا يُنسَب إلى جهةٍ رسميةٍ ولا يتكلّم باسمها. فيُكتَب عنوانُه بالخطّ.
    'meethaq-almasjid': 'غلافُه يحمل شعارَ الدولة والوزارة، والتطبيقُ لا يُنسَب إليهما',
}
