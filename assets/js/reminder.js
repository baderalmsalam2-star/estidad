...
export function icsFor(hhmm, { title = 'وِرد الاستعداد', url = '' } = {}) {
  ...
  const lines = [
    ...
    'RRULE:FREQ=DAILY',
    /*
     * الحدثُ يدخل تقويمَ الإمام، والتقويمُ يُزامَن إلى سحابةٍ ويُشارَك في
     * العمل. فصفتان تُكتَبان:
     *
     *   • `TRANSP:TRANSPARENT` — لا يُعلَن الإمامُ «مشغولاً» ربعَ ساعةٍ كلَّ
     *     يومٍ إلى غيرِ نهاية. وبدونها تراه أيُّ أداةِ مواعيدَ تنظر في وقتِه
     *     محجوزاً في ذلك الوقتِ أبداً، ويُبنى على ذلك جدولٌ لم يُردْه.
     *
     *   • `CLASS:PRIVATE` — أنّ المراجعةَ لاختبارِ الأوقافِ شأنٌ خاصّ. ومن
     *     شارك تقويمَه مع زميلٍ أو مع مسجدِه فليس من حقِّنا أن نُعلِن عنه
     *     أنّه يستعدُّ لاختبارِ إمامة.
     *
     * و`CLASS` وصفٌ لا قُفل: يعمل به ما يعمل، ويُهمِله ما يُهمِل — وقد نصَّ
     * RFC 5545 §3.8.1.3 على ذلك صريحاً. فهو أقصى ما يملكه ملفُّ تقويم.
     */
    'TRANSP:TRANSPARENT',
    'CLASS:PRIVATE',
