 ...
 *
 * ولا يُكتَب فيها اسمُ الطالبِ وإن كتبه في التطبيق، ولا شيءٌ عنه — فالصورةُ
 * تخرج إلى غيره. (وقد كان يُقال ههنا «التطبيقُ لا يعرف عنه شيئاً أصلاً»، ثمّ
 * صار يعرف اسمَه — `store.name()` — فبقي الشقُّ الأوّلُ صادقاً والثاني لا.)
 */
/**
